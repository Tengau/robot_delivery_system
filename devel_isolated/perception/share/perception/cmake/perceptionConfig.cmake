...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/debian/robot_delivery_system/src/perception)
  set(perception_DEVEL_PREFIX /home/debian/robot_delivery_system/devel_isolated/perception)
  ...
  set(perception_INSTALL_PREFIX /home/debian/robot_delivery_system/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'tenzi <tenzi@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/debian/robot_delivery_system/src/perception/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/debian/robot_delivery_system/devel_isolated/perception/lib;/home/debian/robot_delivery_system/devel_isolated/path_planning/lib;/home/debian/robot_delivery_system/devel_isolated/navigation/lib;/home/debian/robot_delivery_system/devel_isolated/localization/lib;/home/debian/robot_delivery_system/devel_isolated/perception/lib;/home/debian/robot_delivery_system/devel_isolated/delta_lidar/lib;/home/debian/ros_catkin_ws/install_isolated/lib)
