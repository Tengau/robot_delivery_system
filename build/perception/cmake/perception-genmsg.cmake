...
set(MSG_I_FLAGS "-Iperception:/home/debian/robot_delivery_system/src/perception/msg;-Isensor_msgs:/home/debian/catkin_ws/install_isolated/share/sensor_msgs/cmake/../msg;-Istd_msgs:/home/debian/catkin_ws/install_isolated/share/std_msgs/cmake/../msg;-Igeometry_msgs:/home/debian/catkin_ws/install_isolated/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/debian/robot_delivery_system/src/perception/msg/FloatArray.msg" NAME_WE)
add_custom_target(_perception_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "perception" "/home/debian/robot_delivery_system/src/perception/msg/FloatArray.msg" ""
)
...
_generate_msg_cpp(perception
  "/home/debian/robot_delivery_system/src/perception/msg/FloatArray.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/perception)
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/perception")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/perception
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
