...
def direction(destination):
    ...
    directory = 'cd robot_delivery_system && source devel_isolated/setup.bash && export ROS_IP=192.168.8.1 && rosnode kill -a && roslaunch executive beaglebone.launch destination:=' + destination
